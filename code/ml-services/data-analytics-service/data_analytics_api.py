...
# Ensure service directory is importable and anomaly-detection-service is reachable
_SERVICE_DIR = os.path.dirname(os.path.abspath(__file__))
_ANOMALY_DIR = os.path.join(_SERVICE_DIR, "..", "anomaly-detection-service")
for _p in (_SERVICE_DIR, _ANOMALY_DIR):
...
model_path = os.path.join(_SERVICE_DIR, "analytics_models.joblib")
