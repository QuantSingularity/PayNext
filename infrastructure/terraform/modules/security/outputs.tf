...
output "security_hub_account_id" {
  ...
  value       = var.enable_security_hub ? aws_securityhub_account.paynext_security_hub[0].id : null
}

output "config_recorder_name" {
  description = "Name of the AWS Config configuration recorder"
  value       = var.enable_config ? aws_config_configuration_recorder.paynext_config_recorder[0].name : null
}

output "config_delivery_channel_name" {
  description = "Name of the AWS Config delivery channel"
  value       = var.enable_config ? aws_config_delivery_channel.paynext_config_delivery_channel[0].name : null
}
