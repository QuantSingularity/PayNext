      ...
      var n,
        ...
        h = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        u = (e, t) => {
          for (var r in t || (t = {})) s.call(t, r) && h(e, r, t[r]);
          if (l) for (var r of l(t)) a.call(t, r) && h(e, r, t[r]);
          return e;
        },
        c = (e, t) => {
          var r = {};
      ...
      (((e) => {
        let t = class t {
          ...
          static encodeText(r, n) {
            let i = e.QrSegment.makeSegments(r);
            return t.encodeSegments(i, n);
          }
          static encodeBinary(r, n) {
            let i = e.QrSegment.makeBytes(r);
            return t.encodeSegments([i], n);
          }
          static encodeSegments(e, n, o = 1, s = 40, a = -1, h = !0) {
            let u, c;
            if (
              !(t.MIN_VERSION <= o && o <= s && s <= t.MAX_VERSION) ||
              a < -1 ||
              a > 7
            )
            ...
            for (let e of [t.Ecc.MEDIUM, t.Ecc.QUARTILE, t.Ecc.HIGH])
              h && c <= 8 * t.getNumDataCodewords(u, e) && (n = e);
            let d = [];
            for (let t of e)
              for (let e of (r(t.mode.modeBits, 4, d),
              r(t.numChars, t.mode.numCharCountBits(u), d),
              t.getData()))
                d.push(e);
            i(d.length == c);
            let f = 8 * t.getNumDataCodewords(u, n);
            (i(d.length <= f),
              r(0, Math.min(4, f - d.length), d),
          ...
          drawFormatBits(e) {
            ...
            let o = ((t << 10) | r) ^ 21522;
            i(o >>> 15 == 0);
            for (let e = 0; e <= 5; e++) this.setFunctionModule(8, e, n(o, e));
            (this.setFunctionModule(8, 7, n(o, 6)),
              this.setFunctionModule(8, 8, n(o, 7)),
              this.setFunctionModule(7, 8, n(o, 8)));
            for (let e = 9; e < 15; e++)
              this.setFunctionModule(14 - e, 8, n(o, e));
            for (let e = 0; e < 8; e++)
              this.setFunctionModule(this.size - 1 - e, 8, n(o, e));
            for (let e = 8; e < 15; e++)
              this.setFunctionModule(8, this.size - 15 + e, n(o, e));
          ...
          drawFinderPattern(e, t) {
            for (let r = -4; r <= 4; r++)
              for (let n = -4; n <= 4; n++) {
                let i = Math.max(Math.abs(n), Math.abs(r)),
                  o = e + n,
                  l = t + r;
                0 <= o &&
                  o < this.size &&
          ...
          addEccAndInterleave(e) {
            ...
            let o = t.NUM_ERROR_CORRECTION_BLOCKS[n.ordinal][r],
              l = t.ECC_CODEWORDS_PER_BLOCK[n.ordinal][r],
              s = Math.floor(t.getNumRawDataModules(r) / 8),
              a = o - (s % o),
              h = Math.floor(s / o),
              u = [],
              c = t.reedSolomonComputeDivisor(l);
            for (let r = 0, n = 0; r < o; r++) {
              let i = e.slice(n, n + h - l + (r < a ? 0 : 1));
              n += i.length;
              let o = t.reedSolomonComputeRemainder(i, c);
              (r < a && i.push(0), u.push(i.concat(o)));
            }
            let d = [];
            for (let e = 0; e < u[0].length; e++)
              u.forEach((t, r) => {
                (e != h - l || r >= a) && d.push(t[e]);
              });
          ...
          drawCodewords(e) {
            ...
            for (let t = this.size - 1; t >= 1; t -= 2) {
              ...
              for (let i = 0; i < this.size; i++)
                for (let o = 0; o < 2; o++) {
                  let l = t - o,
                    s = ((t + 1) & 2) == 0 ? this.size - 1 - i : i;
                  !this.isFunction[s][l] &&
                    r < 8 * e.length &&
                    ((this.modules[s][l] = n(e[r >>> 3], 7 - (7 & r))), r++);
                }
            }
            i(r == 8 * e.length);
          }
          ...
          getPenaltyScore() {
              ...
              for (let l = 0; l < this.size; l++)
                this.modules[r][l] == n
                  ...
                  : (this.finderPenaltyAddHistory(i, o),
                    ...
                    (n = this.modules[r][l]),
                    (i = 1));
              e += this.finderPenaltyTerminateAndCount(n, i, o) * t.PENALTY_N3;
            }
            for (let r = 0; r < this.size; r++) {
              let n = !1,
                i = 0,
            ...
            for (let r = 0; r < this.size - 1; r++)
              for (let n = 0; n < this.size - 1; n++) {
                let i = this.modules[r][n];
                i == this.modules[r][n + 1] &&
                  i == this.modules[r + 1][n] &&
                  i == this.modules[r + 1][n + 1] &&
                  (e += t.PENALTY_N2);
              }
            let r = 0;
            ...
            let n = this.size * this.size,
              o = Math.ceil(Math.abs(20 * r - 10 * n) / n) - 1;
            return (
              i(0 <= o && o <= 9),
          ...
          static reedSolomonComputeRemainder(e, r) {
            ...
            for (let i of e) {
              let e = i ^ n.shift();
              (n.push(0),
                r.forEach((r, i) => (n[i] ^= t.reedSolomonMultiply(r, e))));
            }
            return n;
          }
        ...
        let o = class e {
          ...
          static makeNumeric(t) {
            ...
            for (let e = 0; e < t.length; ) {
              ...
              (r(parseInt(t.substring(e, e + i), 10), 3 * i + 1, n), (e += i));
            }
          ...
          static makeAlphanumeric(t) {
            ...
            for (n = 0; n + 2 <= t.length; n += 2) {
              let o = 45 * e.ALPHANUMERIC_CHARSET.indexOf(t.charAt(n));
              r((o += e.ALPHANUMERIC_CHARSET.indexOf(t.charAt(n + 1))), 11, i);
            }
            return (
              n < t.length &&
                r(e.ALPHANUMERIC_CHARSET.indexOf(t.charAt(n)), 6, i),
              new e(e.Mode.ALPHANUMERIC, t.length, i)
            );
          }
        ...
        return (
          e.forEach(function (e, n) {
            ...
            e.forEach(function (o, l) {
              if (!o && null !== i) {
                (r.push(`M${i + t} ${n + t}h${l - i}v1H${i + t}z`), (i = null));
                return;
              }
              if (l === e.length - 1) {
                if (!o) return;
                null === i
                  ...
                  : r.push(`M${i + t},${n + t} h${l + 1 - i}v1H${i + t}z`);
                return;
              }
              o && null === i && (i = l);
            });
      ...
      function M({
        ...
        let h = i.useMemo(() => {
            let n = (Array.isArray(e) ? e : [e]).reduce(
              (e, t) => (e.push(...d.QrSegment.makeSegments(t)), e),
              [],
            );
            return d.QrCode.encodeSegments(n, f[t], r, void 0, void 0, a);
          }, [e, t, r, a]),
          {
            cells: u,
            margin: c,
            ...
            let e = h.getModules(),
              ...
              i = (function (e, t, r, n) {
                ...
                let i = e.length + 2 * r,
                  ...
                  s = (n.width || o) * l,
                  a = (n.height || o) * l,
                  h = null == n.x ? e.length / 2 - s / 2 : n.x * l,
                  u = null == n.y ? e.length / 2 - a / 2 : n.y * l,
                  c = null == n.opacity ? 1 : n.opacity,
                  d = null;
                if (n.excavate) {
                  let e = Math.floor(h),
                    t = Math.floor(u),
            ...
            if (null != v.current) {
              ...
              let r = O,
                ...
                o =
                  ...
                  0 !== i.naturalHeight &&
                  0 !== i.naturalWidth;
              o && null != L.excavation && (r = y(O, L.excavation));
              let a = window.devicePixelRatio || 1;
              e.height = e.width = n * a;
              let h = (n / x) * a;
              (t.scale(h, h),
                (t.fillStyle = l),
                t.fillRect(0, 0, x, x),
                (t.fillStyle = s),
                C
                  ? t.fill(new Path2D(E(r, _)))
                  : O.forEach(function (e, r) {
                      e.forEach(function (e, n) {
                        e && t.fillRect(n + _, r + _, 1, 1);
                      });
                    }),
                L && (t.globalAlpha = L.opacity),
                o && t.drawImage(i, L.x + _, L.y + _, L.w, L.h));
            }
          }),
            i.useEffect(() => {
              I(!1);
            }, [N]));
          let b = u({ height: n, width: n }, p),
            z = null;
          return (
            null != N &&
              (z = i.createElement("img", {
                src: N,
                key: N,
                style: { display: "none" },
                onLoad: () => {
            ...
            i.createElement(
              ...
              i.createElement(
                "canvas",
                u({ style: b, height: n, width: n, ref: k, role: "img" }, A),
              ),
              z,
            )
          );
        });
      ((R.displayName = "QRCodeCanvas"),
        (i.forwardRef(function (e, t) {
          ...
          null != R &&
            null != v &&
            (null != v.excavation && (P = y(A, v.excavation)),
            (k = i.createElement("image", {
              href: R.src,
              height: v.h,
              width: v.w,
              x: v.x + p,
          ...
          return i.createElement(
            ...
            !!f && i.createElement("title", null, f),
